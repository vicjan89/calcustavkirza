...
def ct_metods(te: TextEngine):
    ...
    te.p('где ' + te.m(
        r'Z_{\text{КАБ}}') + ' - сопротивление кабельной линии от трансформатора тока до конечного потребителя; ')
    ...
    te.p('Предельно допустимая кратность тока ' + te.m(
        r'K_{\text{10доп}}') + ' в заданном классе точности при фактической '
    ...
    te.p('где ' + te.m(
        r'I_{\text{1макс.}}') + ' - максимальный ток, проходящий через трансформатор тока при к. з. в таких точках '
    ...
    te.p('где ' + te.m(
        r'I_{\text{макс.внутр}}') + ' – максимальный расчетный ток короткого замыкания в зоне действия защиты;')
    te.p(te.m(r'I_{H1}') + ' – номинальный первичный ток ТТ')
    te.p(
        'Обобщенный параметр ' + te.m(r'A_{\text{расч}}') + ', определяющий величину токовой погрешности по превышению '
    ...
    te.p(te.m(r'K_{\text{У}}') + f' - ударный коэффициент равный 1.85')
